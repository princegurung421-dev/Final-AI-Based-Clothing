...
export default function AssistantPage() {
  ...
  return (
    <div className="flex h-full bg-[#FAFAF9] text-[#1C1C1A]">
      ...
      <aside
        className={cn(
          "shrink-0 bg-white border-r border-border/50 flex flex-col",
          "w-[280px]",
          "fixed lg:static top-0 left-0 bottom-0 z-50 h-full lg:h-auto",
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile toolbar */}
        <div className="lg:hidden flex items-center gap-2 px-4 py-2 border-b border-border/40 bg-white">
          <button
